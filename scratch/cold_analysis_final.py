...
df_f = features.add_time_features(df_f, df["openTime"], is_forex=True)
...
print("-" * 50)
print("Вывод:")
print("- При пороге 50% бот входит во все сделки, WR обычно около 50-52%.")
print("- При увеличении порога (60-70%) бот отбирает только самые сильные сигналы, WR должен расти (обычно 56-62%).")
print("- Точка безубытка при выплате 80% = 55.5% WR.")
