    ...
    try {
        ...
        setTimeout(() => {
            ...
            if (wPhase && data.uiMarketPhase) {
                ...
                // Пользователь просил "замедление разворот" сделать красным
                if (data.uiMarketPhase.includes("Замедление") || 
                    data.uiMarketPhase.includes("Боковик") || 
                    data.uiMarketPhase.includes("Неопределенность") || 
                    data.uiMarketPhase.includes("Слабый") || 
                    data.uiMarketPhase.includes("Волатильный") || 
                    data.uiMarketPhase.includes("Резкий") || 
                    data.uiMarketPhase.includes("Шум")) {
